...
$(function () {
  ...
  *********************************/
  ...
  submitBtn.on("click", function (e) {
    ...
    ValidateNotEmptyInput(userName, "Por favor, ingrese su nombre");
    ValidateNotEmptyInput(userEmail, "Por favor, ingrese su correo electrónico");
    ValidateNotEmptyInput(msgSubject, "Por favor, ingrese su asunto");
    ValidateNotEmptyInput(msgText, "Por favor, ingrese su mensaje");
    ...
    if (isValidInput && isValidEmail) {
      $.ajax({
        ...
        success: function (data) {
          $(".done-msg")
            .text("Gracias, Su Mensaje Ha Sido Recibido!")
            .toggleClass("show");
          setTimeout(function () {
